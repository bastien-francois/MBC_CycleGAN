...
rank_version=True #not important here

Ind_season = np.array(range(13870))

#### Load tas and pr
os.chdir("/gpfswork/rech/eal/urq13cl/CycleGAN/Article/Code_and_Data/Data/SAFRANdet/")
...
#To avoid effet de bord, take large region
...
os.chdir("/gpfswork/rech/eal/urq13cl/CycleGAN/Article/Code_and_Data/Data/IPSLMRbili/")
_, LON_Paris, LAT_Paris, _, _, IND_Paris, point_max, _ = CycleGAN.load_RData_minmaxrank(rank_version,"tas_pr_day_IPSLMRbili_79_16_Paris", "tas_day_IPSLMRbili_79_16_Paris", Ind_season, region = "Paris")
...
os.chdir("/gpfswork/rech/eal/urq13cl/CycleGAN/Article/Code_and_Data/Data/SAFRANdetbili/")
