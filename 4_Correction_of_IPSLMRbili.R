#### Bias correction of IPSLMRbili for T2 and PR, CVchrono and CVunif for
#### 1. QQ
#### 2. R2D2
#### 3. dOTC
...
#### Save CVchrono
setwd("/gpfswork/rech/eal/urq13cl/CycleGAN/Article/Code_and_Data/Data/MBC/SAFRAN_IPSLMRbili/CVchrono")
...
#### Save CVunif
setwd("/gpfswork/rech/eal/urq13cl/CycleGAN/Article/Code_and_Data/Data/MBC/SAFRAN_IPSLMRbili/CVunif")
...
for(CV in CVtype){
  print(CV)
  load(paste0("/gpfswork/rech/eal/urq13cl/CycleGAN/Article/Code_and_Data/Data/MBC/SAFRAN_IPSLMRbili/", CV, "/tas_pr_day_", CV, "_1dQQ_SAFRAN_IPSLMRbili_79_16_Paris.RData"))
  assign(paste0('Ind_', CV, '_Calib'),list("winter_79_16"=get(paste0('Ind_', CV, '_Calib_winter_79_16')),
                                           "summer_79_16"=get(paste0('Ind_', CV, '_Calib_summer_79_16')),
                                           "automn_79_16"=get(paste0('Ind_', CV, '_Calib_automn_79_16')),
                                           "spring_79_16"=get(paste0('Ind_', CV, '_Calib_spring_79_16'))))
...
for(CV in CVtype){
  ...
  for(season in names(get(paste0('Ind_', CV, '_Calib')))){
    ...
    eval(parse(text=paste0("tas_day_", CV, "_SpatialdOTC_SAFRAN_IPSLMRbili_79_16_Paris[,,","Ind_",CV,"_Calib[[season]]]=final_res_Calib")))
    eval(parse(text=paste0("tas_day_", CV, "_SpatialdOTC_SAFRAN_IPSLMRbili_79_16_Paris[,,","Ind_",CV,"_Proj[[season]]]=final_res_Proj")))
  }
  ...
  for(season in names(get(paste0('Ind_', CV, '_Calib')))){
    ...
    eval(parse(text=paste0("pr_day_", CV, "_SpatialdOTC_SAFRAN_IPSLMRbili_79_16_Paris[,,","Ind_",CV,"_Calib[[season]]]=final_res_Calib")))
    eval(parse(text=paste0("pr_day_", CV, "_SpatialdOTC_SAFRAN_IPSLMRbili_79_16_Paris[,,","Ind_",CV,"_Proj[[season]]]=final_res_Proj")))
  }
}
# 
# # 
